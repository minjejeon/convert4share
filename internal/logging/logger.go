...
// The logger writes to a rotating log file next to the executable and
// also mirrors output to stderr when stderr is actually usable (i.e.
// not when running under windowsgui where stderr is detached).
package logging
