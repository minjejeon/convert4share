...
export function SettingsVideo({ settings, onSettingsChange }: SettingsVideoProps) {
    return (
        <div className="bg-white dark:bg-slate-800/40 rounded-xl p-6 border border-slate-200 dark:border-slate-700/50 hover:border-slate-300 dark:hover:border-slate-600/50 transition-colors space-y-6 shadow-sm dark:shadow-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        onChange={(e) => onSettingsChange({ ...settings, hardwareAccelerator: e.target.value } as main.Settings)}
                    >
                ...
                <div className="space-y-2">
                    ...
                    <select
                        ...
                        onChange={(e) => onSettingsChange({ ...settings, videoQuality: e.target.value } as main.Settings)}
                    >
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={(e) => onSettingsChange({ ...settings, maxFfmpegWorkers: parseInt(e.target.value) || 1 } as main.Settings)}
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={(e) => onSettingsChange({ ...settings, maxSize: parseInt(e.target.value) || 0 } as main.Settings)}
            ...
            <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-slate-700/50">
                ...
                <input
                    ...
                    onChange={(e) => onSettingsChange({ ...settings, ffmpegCustomArgs: e.target.value } as main.Settings)}
