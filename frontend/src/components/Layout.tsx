...
export function Layout({ children, currentView, onNavigate }: LayoutProps) {
    return (
        <div
            ...
            className="drop-window h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans selection:bg-indigo-500/30 overflow-hidden"
        >
