...
export function DropZone({ onFilesAdded, isCompact = false }: DropZoneProps) {
    ...
    if (isCompact) {
        return (
            <div
                ...
                className={cn(
                    "group relative overflow-hidden border border-dashed rounded-xl px-4 py-3 transition-all duration-300 ease-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500",
                    isDragging
    ...
    return (
        <div
            ...
            onKeyDown={handleKeyDown}
            className={cn(
                "group relative overflow-hidden border border-dashed rounded-xl p-10 text-center transition-all duration-300 ease-out cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500",
                isDragging
                    ? "border-indigo-500/50 bg-indigo-50 dark:bg-indigo-500/5 scale-[1.01] shadow-lg shadow-indigo-500/10"
                    : "border-slate-300/60 dark:border-slate-700/40 bg-slate-100/50 dark:bg-slate-800/20 hover:border-indigo-500/20 hover:bg-slate-200/50 dark:hover:bg-slate-800/40"
                        )}
